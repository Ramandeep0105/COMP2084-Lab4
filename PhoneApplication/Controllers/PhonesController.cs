...
namespace PhoneApplication.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhoneID,PhoneName,MSRP,ScreenSize,DateReleased,ManufacturerID")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhoneID,PhoneName,MSRP,ScreenSize,DateReleased,ManufacturerID")] Phone phone)
        {
            if (ModelState.IsValid)
            {
